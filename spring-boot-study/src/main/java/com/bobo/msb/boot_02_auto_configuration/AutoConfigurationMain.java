...
public class AutoConfigurationMain {
	 ...
	 *
	 * 4、注意：⚠️⚠️⚠️会把SpringApplication.run()参数中的Class bd注册到beanFactory中，main所在的Class不会注册！
	 */
	public static void main(String[] args) {
		// 注意：⚠️⚠️⚠️会把SpringApplication.run()参数中的Class bd注册到beanFactory中，main所在的Class不会注册！
